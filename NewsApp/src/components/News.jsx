  ...
  },
{
  ...
  "publishedAt": "2024-08-16T09:00:00",
        ...
        {/* map function to add all elem */}
          {this.articles.map((element) => {
            return <div className="col md-4 my-3" key={element.publishedAt}>
              <NewsItem title={element.title.slice(0,20)} description={element.description.slice(0,50)} imageUrl={element.urlToImage} newsUrl={element.url} />
